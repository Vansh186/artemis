...
module.exports = {
  ...
  run: async (client, message, args, user, text, prefix) => {
    message.channel.send(new MessageEmbed()
      .setTitle(`This Bot is made by \`Van.sh07\` and **this** is the Source Code link to this Bot`)
      .setURL("https://github.com/Vansh186/artemis")
      ...
      .addField("Source Code. ", "Don't just use the source for yourself,... please [invite](https://discord.com/oauth2/authorize?client_id=852597421161709608&scope=bot&permissions=8) me too![\`Click here\`](https://github.com/Vansh186/artemis)")
